...
def calculates_results_stats(results_dic):
    ...
    for k9file in results_dic:
        ...
        if results_dic[k9file][2] == 1:
            results_stats_dic['n_match'] += 1

        if results_dic[k9file][2] == 1 and results_dic[k9file][3] == 1:
            results_stats_dic['n_correct_breed'] += 1
        
        
        # Pet Image Label is a Dog - counts number of dog images
        if results_dic[k9file][3] == 1:
            results_stats_dic['n_dogs_img'] += 1
            
            if results_dic[k9file][4] == 1:
                results_stats_dic['n_correct_dogs'] += 1

   
        else:
            
            if results_dic[k9file][3] == 0 and results_dic[k9file][4] == 0:
